...
function Animation.PlayAnimation(Character, Track)
	...
	Animation.Loaded[Character][Track]:Play(0.1)
end
...
function Animation.StopAnimation(Character, Track)
	...
	Animation.Loaded[Character][Track]:Stop(0.1)
end
...
function Animation.PlayCameraAnimation(CamAnim: Animation, CharacterFocus)
	...
	local CameraRig = ReplicatedStorage.Shared.Assets.Animations.CamRigWithLetterBox:Clone()
	...
	if CamAnim:GetAttribute("Marbles") then
		...
		CameraRig.RootPart.CFrame = CharacterFocus
				and CharacterFocus.PrimaryPart.CFrame * CFrame.fromOrientation(math.rad(0), math.rad(180), math.rad(0))
			or Character.PrimaryPart.CFrame * CFrame.fromOrientation(math.rad(0), math.rad(180), math.rad(0))
	end
