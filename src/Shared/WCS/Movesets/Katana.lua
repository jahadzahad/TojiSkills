...
local Katana = require(Skills.Combat.Attacks.Katana)
...
local CriticalAttack = require(Skills.Combat.CriticalAttacks.Katana)
...
return WCS.CreateMoveset("Katana", { Katana, Block, BlockBreak, Parry, Slide, SlideAttack, Dash, DropKick, SlideJump, Evade, Pludge, CriticalAttack, Uptilt })
