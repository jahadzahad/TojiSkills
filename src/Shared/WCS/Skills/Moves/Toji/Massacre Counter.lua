...
-- Animation assets
local AnimationAssets = ReplicatedStorage.Shared.Assets.Animations.Movesets.Enel[ 'Celestial Blitz' ]

local VFX

local Animations = {
	User = AnimationAssets:WaitForChild( 'User' ),
	Hit = AnimationAssets:WaitForChild( 'Hit' ),
